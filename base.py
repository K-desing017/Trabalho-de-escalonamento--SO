...
# Função principal,nela são criadas as listas que armazenam informações dos processos abaixo.
def main():
    ...
    #  a função é chamada para criar processos, o usuario escolhe se quer gerar aleatorio ou manual
    ...
    # esse é o menu de escolha para ver qual algoritmo será executado.
    while True:
